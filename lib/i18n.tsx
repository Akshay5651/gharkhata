...
const en = {
  ...
  chooseWork: 'Choose work type',
  orTypeWork: 'Or type a role not in the list:',
  phone: 'Phone',
  ...
  qtyHint: (unit: string) => `Numbers on present days show ${unit} delivered that day.`,
  ...
  accentLockedTitle: 'Premium colour',
  accentLockedBody: 'Unlock 5+ colour schemes with Premium.',
  ...
  featColors: '5+ new colour schemes',
  ...
  reminderAskTitle: 'Never lose your data',
  reminderAskBody: 'Everything lives only on this phone. Turn on a gentle reminder every 15 days to export a backup — takes one tap, and you can turn it off anytime in Settings.',
  ...
  workRequiredBody: 'Choose or type a work type before saving.',
  amountRequiredBody: 'Enter an amount greater than zero.',
  payType: 'Pay type',
  payTypePer: 'Pay type per',
  payTypeMonth: 'Month',
  payTypeDay: 'Day',
  payTypeHour: 'Hour',
  payTypeUnit: 'Unit',
...
const hi: Dict = {
  ...
  chooseWork: 'काम का प्रकार चुनें',
  orTypeWork: 'या सूची में न हो तो खुद लिखें:',
  phone: 'फ़ोन',
  ...
  qtyHint: (unit: string) => `उपस्थित दिनों पर लिखा नंबर उस दिन दी गई ${unit} की मात्रा है।`,
  ...
  accentLockedTitle: 'प्रीमियम रंग',
  accentLockedBody: 'Premium के साथ 5+ रंग योजनाएं अनलॉक करें।',
  ...
  reminderAskTitle: 'अपना डेटा कभी न खोएं',
  reminderAskBody: 'सारा डेटा सिर्फ़ इस फ़ोन में रहता है। हर 15 दिन में बैकअप लेने की याद चालू करें — एक टैप में, और इसे Settings से कभी भी बंद कर सकते हैं।',
  ...
  notificationsEnabledToast: 'सूचना चालू हो गई',
  notificationsDisabledToast: 'सूचना बंद हो गई',
  fine: 'कटौती',
  amount: 'रकम',
  ...
  workRequiredBody: 'सेव करने से पहले काम का प्रकार चुनें या लिखें।',
  amountRequiredBody: 'शून्य से बड़ी रकम डालें।',
  payType: 'भुगतान का तरीका',
  payTypePer: 'भुगतान इस हिसाब से',
  payTypeMonth: 'महीना',
  payTypeDay: 'दिन',
  payTypeHour: 'घंटा',
  payTypeUnit: 'यूनिट',
  ...
  accentGold: 'सुनहरा',
  accentTeal: 'फ़िरोज़ी',
  accentMagenta: 'गहरा गुलाबी',
  accentIndigo: 'जामुनी नीला',
